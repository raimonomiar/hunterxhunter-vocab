...
- Kanji: 諸君
- Kana: しょくん
- English: everyone\, you all \(formal\, addressing a group\)
- Notes:
...
- Kanji: 脱出する
- Kana: だっしゅつする
- English: to escape\, to break out \(of\)
- Notes: text\: タワーを脱出した順に — in the order you escaped the tower
...
- Kanji: 結構
- Kana: けっこう
- English: fine\, all right\, permissible
- Notes: text\: 自由に処分してもらって結構 — you\'re free to dispose of it as you like
...
- Notes: Text glosses it with the furigana ターゲット \(target\) instead of the normal reading\; text\: それぞれの獲物だ — that\'s each of your targets
...
- Kanji: 気を落とす
- Kana: きをおとす
- English: to be discouraged\, to lose heart
- Notes: Idiom\; text\: 気を落とさずに来年また挑戦して — don\'t be discouraged\, and try again next year
...
- Kanji: 懐
- Kana: ふところ
- English: bosom\, the inside of one\'s coat\, one\'s pocket
- Notes: text\: 懐にしまい込んでいた — tucked it away inside their coat
...
- Kanji: 視線
- Kana: しせん
- English: one\'s gaze\, line of sight
- Notes: text\: 誰とも視線をあわせず — without meeting anyone\'s eyes
...
- Notes: Text writes it in katakana \(ナイショ\)
...
- Notes: Cue phrase before doing something together\; text\: せーので見せっこするか\? — want to show each other on three\?
...
- Kanji: 生き残る
- Kana: いきのこる
- English: to survive\, to remain alive
- Notes: text\: 生き残れよ、ゴン — survive\, Gon
...
- Kanji: 下船する
- Kana: げせんする
- English: to disembark\, to get off a ship
- Notes:
...
- Kanji: 身を隠す
- Kana: みをかくす
- English: to hide oneself\, to conceal oneself
- Notes: text\: 自分は先に身を隠し — I\'ll hide myself first
...
- Kanji: 鋭い
- Kana: するどい
- English: sharp\, keen \(of senses or intuition\)
- Notes: text\: なかなかカンの鋭いボウヤだぜ — quite a sharp\-instinct kid
...
- Kanji: 坊や
- Kana: ぼうや
- English: little boy\, sonny \(condescending term of address\)
- Notes: Text writes it in katakana \(ボウヤ\)
...
- Kanji: 焦る
- Kana: あせる
- English: to rush\, to hurry\, to be impatient
- Notes: text\: あせらずじっくり狩るか — guess I\'ll hunt him slowly\, without rushing
