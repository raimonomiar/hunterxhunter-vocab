...
- Kanji: 密林
- Kana: みつりん
- English: a dense forest\, a jungle
- Notes: text\: いきなり魔物が棲む密林に迷いこんだみたいだ\!\! — it\'s like we suddenly wandered into a jungle where monsters dwell\!\!
- WK level:
...
- Kana: めいよ
- English: honor\, glory
- Notes: text\: 名誉のみの戦いとなりますので — since it becomes a battle for honor alone
- WK level:
...
- Notes: text\: あらゆる武器の使用が認められます — the use of any and all weapons is permitted
- WK level:
...
- Kanji: 格闘
- Kana: かくとう
- English: fighting\, hand\-to\-hand combat
...
- Kanji:
- Kana: せっかく
- English: going to the trouble of\, after all that effort \(often implying it was wasted\)
- Notes: text\: せっかくここまで来たのに… — after all the trouble of coming this far\.\.\.
- WK level:
...
- Kanji: 通す
- Kana: とおす
- English: to let \(someone\/something\) pass\, to allow through
- Notes: text\: 通さないよ — I won\'t let you through
- WK level:
...
- Notes: text\: 彼の念に対し君達はあまりに無防備だ — you two are far too defenseless against his Nen
- WK level:
...
- Kanji: 凍える
- Kana: こごえる
- English: to freeze\, to become numb with cold
- Notes: text\: 全身凍えながら — while one\'s whole body freezes
- WK level:
...
- Kanji: 負担をかける
- Kana: ふたんをかける
- English: to place a burden\/strain on
- Notes: text\: 心身に負担をかけると死にかねないよ — placing a strain on mind and body could well get you killed
- WK level:
...
- Kanji: 挑戦する
- Kana: ちょうせんする
- English: to challenge\, to make an attempt
- Notes: text\: また1階から挑戦し直していただけます — you\'ll be able to try again starting from floor 1
- WK level:
...
- Notes: text\: 以前登録を断ってらっしゃいますから — since you previously declined registration
- WK level:
...
- Notes: text\: また未登録という形になりますと — and if it becomes a case of being \"unregistered\" again
- WK level:
...
- Kana: ふかのう
- English: impossible
- Notes: text\: 参加自体不可能となってしまいます — participation itself will become impossible
- WK level:
...
- Kanji: 念
- Kana: ねん
- English: \"Nen\" — the life\-energy that flows from within all living things and can be sensed\, controlled\, and used as a fighting technique
- Notes: text\: これが念です。念とは体からあふれ出す生命エネルギーを自在に操る能力のこと — this is Nen\. Nen is the ability to freely control the life energy that overflows from the body
- WK level:
...
- Kanji: 自在に
- Kana: じざいに
- English: freely\, at will
- Notes: text\: 生命エネルギーを自在に操る能力 — the ability to freely control life energy
- WK level:
...
- Kanji: 操る
- Kana: あやつる
- English: to manipulate\, to control skillfully
- Notes: text\: 生命エネルギーを自在に操る能力のこと — the ability to freely control life energy
- WK level:
...
- Kanji: 微量
- Kana: びりょう
- English: a minute amount\, a trace amount
- Notes: text\: 誰もが微量ながら放出しているが — everyone releases it\, if only in a trace amount
- WK level:
...
- Kanji: 放出する
- Kana: ほうしゅつする
- English: to release\, to emit\, to discharge
- Notes: text\: 微量ながら放出しているが — releases it\, if only in a trace amount
- WK level:
...
- Kanji: 垂れ流し
- Kana: たれながし
- English: letting flow unchecked\, an uncontrolled discharge
- Notes: text\: そのほとんどは垂れ流しの状態になっている — most of it is in a state of being let flow unchecked
- WK level:
...
- Kanji: 纏
- Kana: テン
- English: \"Ten\" — the Nen technique of keeping one\'s aura contained within the body instead of letting it leak out
- Notes: text\: これを肉体にとどめる技術を纏\(テン\)といいます — the technique of keeping this within the body is called \"Ten\"
- WK level:
...
- Kanji: 頑強
- Kana: がんきょう
- English: strong\, sturdy\, robust
- Notes: text\: これによって肉体は頑強になり — because of this\, the body becomes tough\/robust
- WK level:
...
- Kanji: 絶
- Kana: ゼツ
- English: \"Zetsu\" — the Nen technique of completely suppressing\/cutting off one\'s aura
- Notes: text\: 絶\(ゼツ\)は字のごとくオーラを絶つ技術 — Zetsu\, just as the character suggests\, is the technique of cutting off one\'s aura
- WK level:
...
- Kanji: 極度
- Kana: きょくど
- English: an extreme degree
- Notes: text\: 極度の疲労を癒やす時などに効果があります — it\'s effective for things like healing extreme fatigue
- WK level:
...
- Notes: text\: 極度の疲労を癒やす — to heal extreme fatigue
- WK level:
...
- Kanji: 癒やす
- Kana: いやす
- English: to heal\, to soothe\, to cure
- Notes: text\: 極度の疲労を癒やす時などに効果があります — it\'s effective for things like healing extreme fatigue
- WK level:
...
- Kanji: 圧迫感
- Kana: あっぱくかん
- English: a feeling of pressure\, oppressiveness
- Notes: text\: ああ…圧迫感がある — ahh\.\.\. there\'s a feeling of pressure
- WK level:
...
- Kanji: 害意
- Kana: がいい
- English: malicious intent\, hostile intent
- Notes: text\: 私に害意がないからです — because I harbor no malicious intent
- WK level:
...
- Kanji: 資質
- Kana: ししつ
- English: natural aptitude\, disposition\, quality
- Notes: text\: 本人の資質によるところが大きい — it\'s largely due to the person\'s own natural aptitude
- WK level:
...
- Kanji: 感性
- Kana: かんせい
- English: sensibility\, sensitivity\, intuitive sense
- Notes: text\: 2人の感性の鋭さには驚かされる — I\'m amazed at the sharpness of their sensibilities
- WK level:
...
- Kanji: 発する
- Kana: はっする
- English: to emit\, to give off\, to generate
- Notes: text\: 人間の内部から発するエネルギー — energy generated from within a human
- WK level:
...
- Kanji: 指摘
- Kana: してき
- English: a pointing out\, an indication \(of a fault or issue\)
- Notes: text\: 少しストレートすぎるんじゃないか\?との指摘があり — there was a comment pointing out\, \"isn\'t this a bit too on\-the\-nose\?\"
- WK level:
...
- Kanji: 安直
- Kana: あんちょく
- English: facile\, easy\, simplistic \(esp\. of a solution or reason\)
- Notes: text\: という安直なきっかけであり — that was the simplistic\/easy reason
- WK level:
...
- Kanji: 言い逃れ
- Kana: いいのがれ
- English: an excuse\, an evasion\, a getting\-out\-of\-it
- Notes: text\: 苦しい言いのがれをしたことを覚えている — I remember making a strained excuse
- WK level:
...
- Kanji: 体たらく
- Kana: ていたらく
- English: a sorry\/deplorable state
- Notes: text\: 200点満点中70点というていたらくぶりである — it\'s such a sorry state that it\'s 70 out of a possible 200 points
- WK level:
